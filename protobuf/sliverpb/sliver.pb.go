...
const file_sliverpb_sliver_proto_rawDesc = "" +
	...
	"\bResponse\x18\t \x01(\v2\x12.commonpb.ResponseR\bResponse\"\xbd\x01\n" +
	"\n" +
	"ExecuteReq\x12\x12\n" +
	...
	"\x06Stderr\x18\x05 \x01(\tR\x06Stderr\x12\x12\n" +
	"\x04PPid\x18\n" +
	" \x01(\rR\x04PPid\x12+\n" +
	"\aRequest\x18\t \x01(\v2\x11.commonpb.RequestR\aRequest\"\x80\x02\n" +
	...
	"\bTunnelID\x18\b \x01(\x04B\x020\x01R\bTunnelID\x12\x1c\n" +
	"\tSessionID\x18\t \x01(\tR\tSessionID\"\x9b\x01\n" +
	"\bShellReq\x12\x12\n" +
	"\x04Path\x18\x01 \x01(\tR\x04Path\x12\x1c\n" +
	...
	"\x03Pid\x18\x03 \x01(\rR\x03Pid\x12\x1e\n" +
	"\bTunnelID\x18\b \x01(\x04B\x020\x01R\bTunnelID\x12.\n" +
	"\bResponse\x18\t \x01(\v2\x12.commonpb.ResponseR\bResponse\"\x9d\x01\n" +
	"\n" +
	"PortfwdReq\x12\x12\n" +
	...
	"\fBeaconJitter\x18\x03 \x01(\x03R\fBeaconJitter\x12+\n" +
	"\aRequest\x18\t \x01(\v2\x11.commonpb.RequestR\aRequest\"=\n" +
	"\vReconfigure\x12.\n" +
	...
	"\x02ID\x18\x01 \x01(\rR\x02ID\x12+\n" +
	"\aRequest\x18\t \x01(\v2\x11.commonpb.RequestR\aRequest\"\xcf\x01\n" +
	...
	"\n" +
	"DISCONNECT\x10\x01B/Z-github.com/bishopfox/sliver/protobuf/sliverpbb\x06proto3"
